---
title: Future interfaces (APIs, dashboards, wrappers)
description: Although CLI is the initial interface, the architecture is designed for future APIs, dashboards, or external integrations.
---
