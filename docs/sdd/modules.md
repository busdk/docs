...
- [`bus update`](./bus-update): Shared module version-check policy and library for release-index checks, cache, timeout, and failure-grace gating used by bus-* modules.
