...
Trusted raw HTML must be narrow. Only framework-owned static fragments,
`AIMarkdown` or an equivalent audited sanitizer, and explicit compatibility
boundaries may produce trusted fragments. Product modules should pass escaped
text and typed props for all other content.
