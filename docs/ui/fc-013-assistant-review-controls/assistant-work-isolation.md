...
[`AIDropController`](../fc-011-assistant-composer-attachments/ai-drop-controller) renders assistant drop
...
- [AIDropController](../fc-011-assistant-composer-attachments/ai-drop-controller)
