...
must come from a named host resolver configured in [runtime config](../v0.4.2/runtime-config)
or from an origin accepted by [API URL resolution](../v0.4.2/api-urls).
