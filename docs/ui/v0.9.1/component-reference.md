...
- [`AppShell`](../v0.2.1/app-shell) - Standard local application frame.
- [`PortalShell`](../v0.2.1/portal-shell) - Portal-mounted feature frame.
- [`SidebarShell`](../v0.2.1/sidebar-shell) - Collapsible multi-view shell.
- [`AssistantShell`](../v0.2.1/assistant-shell) - Business surface with assistant pane.

## Library: Layouts

- [`SidebarNav`](../v0.2.2/sidebar-nav) - Sidebar navigation list.
- [`SplitLayout`](../v0.2.2/split-layout) - Resizable pane layout.

## Library: Surfaces

- [`Panel`](../v0.2.3/panel) - Bounded titled work surface.
- [`SurfaceCard`](../v0.2.3/surface-card) - Repeated or grouped card surface.
- [`MetricCard`](../v0.2.3/metric-card) - Compact dashboard metric.

## Library: Navigation

- [`LinkButton`](../v0.2.4/link-button) - Safe link with button styling.
- [`Menu`](../v0.2.4/menu) - Bounded option menu.
- [`Tabs`](../v0.2.4/tabs) - Sibling view switcher.

## Library: Event Controls

- [`Button`](../v0.2.5/button) - Native event button.
- [`IconButton`](../v0.2.5/icon-button) - Icon-only event button.
- [`EventBar`](../v0.2.5/event-bar) - Ordered event group.

## Library: Icons

- [`Icon`](../v0.2.6/icon) - Shared SVG icon.
