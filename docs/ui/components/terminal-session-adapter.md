...
uses the same chunk schema as [TerminalOutputView](./terminal-output-view),
`approvals` use [TerminalApprovalPrompt](./terminal-approval-prompt) actions,
...
props:
  events: { bind: terminal.events }
  approvals: { bind: terminal.approvals }
```
...
<p class="busdk-prev-next">
  <span class="busdk-prev-next-item busdk-prev">&larr; <a href="./terminal-approval-prompt">TerminalApprovalPrompt</a></span>
  <span class="busdk-prev-next-item busdk-index"><a href="../component-reference">Component reference</a></span>
  <span class="busdk-prev-next-item busdk-next"><a href="./evidence-url-resolver">EvidenceURLResolver</a> &rarr;</span>
</p>
<!-- busdk-docs-nav end -->
