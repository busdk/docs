...
<p class="busdk-prev-next">
  <span class="busdk-prev-next-item busdk-prev">&larr; <a href="./cli-runtime-flags">CLIRuntimeFlags</a></span>
  <span class="busdk-prev-next-item busdk-index"><a href="../component-reference">Component reference</a></span>
  <span class="busdk-prev-next-item busdk-next"><a href="./declarative-renderer">DeclarativeRenderer</a> &rarr;</span>
</p>
<!-- busdk-docs-nav end -->
