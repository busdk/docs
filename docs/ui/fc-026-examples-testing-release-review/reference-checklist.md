...
[session](../fc-005-sessions/session), [credentials](../fc-006-credentials/credentials), and
[provider errors](../fc-007-provider-errors/provider-errors) for host and provider-adjacent
UI concerns.

Use [assistant components](../fc-009-assistant-workbench-shell/assistant-workbench) when the UI
...
Use [terminal components](../fc-014-terminal-sessions/terminal-sessions) when the UI streams
command output, waits on command approval, accepts stdin, or shows command exit
state.

Use [evidence](../fc-018-evidence-urls-links/evidence), [file drops](../fc-021-file-drops/file-drops), and
[image gallery](../fc-022-image-galleries/image-gallery) pages when the UI opens, previews,
