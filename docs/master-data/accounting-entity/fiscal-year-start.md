...
`fiscal_year_start` defines when the accounting entity’s financial year begins. Bookkeeping uses financial year boundaries to structure reporting, support year-end workflows, and make it unambiguous which annual reporting context entries belong to.
