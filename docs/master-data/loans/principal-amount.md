...
`principal_amount` is part of the loans master data. Bookkeeping uses it to keep the register stable and to support deterministic posting, validation, and review workflows.

Example values: `100000.00`, `5000.00`.
