...
| [accounts](../modules/bus-accounts#development-state) | 60% (Stable) – init, add (all five types), set, list, validate and init contract verified; e2e covers full chart workflow; user can complete define-master-data chart step. | Optional: sole-proprietor withdrawal/investment helper (balanced entry from recommended accounts). | None known. |
...
| [period](../modules/bus-period#development-state) | 90% (Broadly usable) — add/open/close/lock and year-rollover opening verified; user can complete period lifecycle. | Optional: automatic result-to-equity transfer at year end. | None known. |
...
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – Init (index+schema only), add, balance, dry-run, NFR-JRN-001 verified; record-postings and balance steps usable. | Optional add-from-stdin (PLAN.md); README/help alignment. | [period](../modules/bus-period) writing closed-period file for full workflow. |
| [balances](../modules/bus-balances#development-state) | 60% (Stable) – Opening/cutover: init, add, import (incl. --allow-unknown-accounts), validate, list, apply and replace verified by e2e; effective-record, replace-marker, apply balanced/order by unit tests; apply uses internal journal. | [bus-period](../modules/bus-period) library for path/state; e2e run bus journal validate after apply (PLAN.md). | None known. |
...
| [accounts](../modules/bus-accounts#development-state) | 60% (Stable) – init, add, set, list, validate verified; income accounts for invoice lines. | Optional SDD follow-ups. | None known. |
| [invoices](../modules/bus-invoices#development-state) | 60% (Stable) – init, validate, list verified by e2e and unit tests; user can bootstrap and list; add and pdf not implemented. | add (header/lines); pdf; totals validation; E2E for add/pdf. | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
...
| Module | Readiness | Biggest next | Biggest blocker |
|--------|-----------|--------------|-----------------|
| [period](../modules/bus-period#development-state) | 90% (Broadly usable) — close, lock, opening with append-only and locked state verified. | Optional: automatic result-to-equity at year end. | None known. |
...
| Module | Readiness | Biggest next | Biggest blocker |
|--------|-----------|--------------|-----------------|
| [period](../modules/bus-period#development-state) | 90% (Broadly usable) — close, lock, opening for snapshots verified. | Optional: automatic result-to-equity at year end. | None known. |
...
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – Append path, balance, NFR-JRN-001 and audit columns verified; evidence-pack posting path ready. | Optional add-from-stdin; README/help alignment. | [period](../modules/bus-period) writing closed-period file for full workflow. |
...
| [accounts](../modules/bus-accounts#development-state) | 60% (Stable) – chart of accounts for wage expense, withholding, net payable; e2e and unit tests cover init, add, set, list, validate; user can define accounts prerequisite. | Optional SDD follow-ups. | None known. |
...
| [period](../modules/bus-period#development-state) | 90% (Broadly usable) — period open/close/lock and opening for payroll month verified. | Optional: automatic result-to-equity at year end. | None known. |
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – Init, add, balance, closed-period reject verified; posting path ready for payroll export. | Optional add-from-stdin; README/help alignment. | [period](../modules/bus-period) writing closed-period file for full workflow. |
