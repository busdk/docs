...
| [reconcile](../modules/bus-reconcile#development-state) | 80% (Broadly usable) – match, allocate, list and validation failures (amount/currency, sum, already-reconciled, missing ref) verified by unit and e2e; reconciliation step completable. | Bank path from [bank](../modules/bus-bank) Go library (PLAN.md). | None known. |
...
| [reconcile](../modules/bus-reconcile#development-state) | 80% (Broadly usable) – match, allocate, list and validation failures verified; reconciliation evidence path completable. | Bank path from [bank](../modules/bus-bank) Go library (PLAN.md). | None known. |
...
| [reconcile](../modules/bus-reconcile#development-state) | 80% (Broadly usable) – match, allocate, list and validation failures verified; payroll bank reconciliation step completable. | Bank path from [bank](../modules/bus-bank) Go library (PLAN.md). | None known. |
