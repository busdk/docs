...
|--------|-----------|--------------|-----------------|
| [books](../modules/bus-books#development-state) | 20% (Basic structure) – serve and capability URL verified by e2e; token gating and workspace checks by unit tests; embedded API core and minimal UI (index, SPA fallback, assets from embed) verified; no domain backends wired; user cannot complete any bookkeeping step in the UI. | Enforce read-only 403 and unit test; wire [api](../modules/bus-api) backends; Dashboard and core screens (PLAN.md). | None known. |
...
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file/stdin, list-templates, flags, overwrite, chdir, repo-relative template, PDF/A verified by e2e and unit tests; user can complete PDF render step. | None in PLAN.md; PDF/A already verified. | None known. |
...
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file/stdin, list-templates, flags, overwrite, chdir, repo-relative template, PDF/A verified by e2e and unit tests; user can complete PDF generation step. | None in PLAN.md; PDF/A already verified. | None known. |
