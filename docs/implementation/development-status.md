...
| [invoices](../modules/bus-invoices#development-state) | 70% (Broadly usable) – init, add (header/lines), validate, list verified by e2e and unit tests; totals validation and add-refuse-on-fail verified; user can create and list invoices; pdf not verified in e2e. | VAT amount validation; tests for list filters (--month, --from, --to, --due-from, --due-to, --counterparty); posting output for journal (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
...
| [reports](../modules/bus-reports#development-state) | 70% (Broadly usable) – trial balance, balance sheet, P&L, general-ledger, account-ledger and global flags verified by e2e and unit tests; optional budget and traceability verified. | KPA/PMA output formats (Finnish compliance). | None known. |
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file and stdin, list-templates, flags, overwrite, chdir, repo-relative template verified by e2e and unit tests; user can complete PDF render step. | Optional PDF/A (PLAN.md). | None known. |
...
| [invoices](../modules/bus-invoices#development-state) | 70% (Broadly usable) – init, add, validate, list verified; user can create and list invoices; pdf step blocked by [pdf](../modules/bus-pdf). | VAT amount validation; tests for list filters; posting output for journal (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file and stdin, list-templates, flags, overwrite, chdir, repo-relative template verified by e2e and unit tests; user can complete PDF generation step. | Optional PDF/A (PLAN.md). | None known. |
...
| [reports](../modules/bus-reports#development-state) | 70% (Broadly usable) – reports and traceability (basis, voucher/entry columns) verified by e2e. | KPA/PMA output formats. | None known. |
...
| [reports](../modules/bus-reports#development-state) | 70% (Broadly usable) – trial balance and ledgers as audit evidence verified by e2e. | KPA/PMA output formats. | None known. |
...
| [invoices](../modules/bus-invoices#development-state) | 70% (Broadly usable) – init, add, validate, list verified; evidence-pack baseline for invoice data; pdf not in journey. | VAT amount validation; tests for list filters; posting output for journal (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
