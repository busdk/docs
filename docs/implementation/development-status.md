...
| [invoices](../modules/bus-invoices#development-state) | 80% (Broadly usable) – init, add, validate (totals and VAT), list with all filters verified by e2e and unit tests; user can complete record-invoices step; pdf not verified in e2e. | Posting output for [journal](../modules/bus-journal) (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
...
| [reports](../modules/bus-reports#development-state) | 80% (Broadly usable) – trial balance, balance sheet, P&L, general-ledger, account-ledger, KPA/PMA formats and global flags verified by e2e and unit tests; optional budget and traceability verified. | None in PLAN.md. | None known. |
...
| [invoices](../modules/bus-invoices#development-state) | 80% (Broadly usable) – init, add, validate (totals and VAT), list with all filters verified; user can complete create-and-list step; pdf step blocked by [pdf](../modules/bus-pdf). | Posting output for [journal](../modules/bus-journal) (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
...
| [filing-vero](../modules/bus-filing-vero#development-state) | 50% (Primary journey) – export and verify from fixture verified by e2e and unit tests; manifest source_refs and root VAT path verified; user can produce and verify a Vero bundle. | Doc update (Risks/pre-export layout per PLAN.md); optional voucher/posting refs in bundle. | [filing](../modules/bus-filing) bundle contract. |
...
| [reports](../modules/bus-reports#development-state) | 80% (Broadly usable) – trial balance and ledgers as audit evidence and KPA/PMA verified by e2e. | None in PLAN.md. | None known. |
...
| [invoices](../modules/bus-invoices#development-state) | 80% (Broadly usable) – init, add, validate (totals and VAT), list with all filters verified; evidence-pack baseline for invoice data; pdf not in journey. | Posting output for [journal](../modules/bus-journal) (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
