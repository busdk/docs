...
| [period](../modules/bus-period#development-state) | 90% (Broadly usable) — init, open, list, validate, close, lock, opening including --replace and --allow-as-of-mismatch verified by e2e and unit tests; user can complete period open/close/lock and year-rollover opening. | Optional: automatic result-to-equity transfer at year end. | None known. |
...
| [period](../modules/bus-period#development-state) | 90% (Broadly usable) — period open/close/lock and opening for payroll month verified; --replace and --allow-as-of-mismatch verified by e2e. | None in PLAN; optional SDD follow-ups. | None known. |
