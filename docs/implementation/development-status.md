...
| [journal](../modules/bus-journal#development-state) | 60% (Stable) – postings and balancing; audit trail for bookkeeping evidence. | Period integrity; layout; audit fields; interactive add. | [period](../modules/bus-period) closed-period checks for full workflow. |
