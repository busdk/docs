...
| [period](../modules/bus-period#development-state) | 80% (Broadly usable) — init, open, list, validate, close, lock, opening verified; merge-conflict and non-Git hint verified. | E2E for opening --replace and --allow-as-of-mismatch (PLAN.md). | None known. |
...
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – Init, add, balance, period integrity and layout/audit columns verified; add with all params via flags verified. | Align add with NFR-009 (usage on missing args); optional add convenience. | [period](../modules/bus-period) writing closed-period file for full workflow. |
...
| Module | Readiness | Biggest next | Biggest blocker |
|--------|-----------|--------------|-----------------|
| [period](../modules/bus-period#development-state) | 80% (Broadly usable) — close, lock, opening with append-only and locked state verified. | E2E for opening --replace and --allow-as-of-mismatch. | None known. |
...
| Module | Readiness | Biggest next | Biggest blocker |
|--------|-----------|--------------|-----------------|
| [period](../modules/bus-period#development-state) | 80% (Broadly usable) — close, lock, opening for snapshots verified. | E2E for opening --replace and --allow-as-of-mismatch. | None known. |
...
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – Postings, balancing, period reject and audit columns verified. | Align add with NFR-009; optional add convenience. | [period](../modules/bus-period) writing closed-period file for full workflow. |
...
| [period](../modules/bus-period#development-state) | 80% (Broadly usable) — period open/close/lock and opening for payroll month verified. | E2E for opening --replace and --allow-as-of-mismatch. | None known. |
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – Append posting path verified; init, add, balance, closed-period reject verified. | Align add with NFR-009; optional add convenience. | [period](../modules/bus-period) writing closed-period file for full workflow. |
