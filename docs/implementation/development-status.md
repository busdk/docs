...
|--------|-----------|--------------|-----------------|
| [books](../modules/bus-books#development-state) | 20% (Basic structure) – serve and capability URL verified by e2e; token gating and workspace checks by unit tests; embedded API core (healthz, openapi, module mount) verified; no domain backends or UI; user cannot complete any bookkeeping step in the UI. | Embed UI assets and wire [api](../modules/bus-api) module backends; Dashboard and core screens (PLAN.md). | None known. |
...
| [invoices](../modules/bus-invoices#development-state) | 80% (Broadly usable) – init, add, validate (totals and VAT), list with all filters, postings verified by e2e and unit tests; user can complete record-invoices and emit posting dataset for [journal](../modules/bus-journal); pdf not verified in e2e. | attachment_id (FR-005) and postings subcommand help (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
...
| [reports](../modules/bus-reports#development-state) | 80% (Broadly usable) – Close-step reports verified by e2e; user can run trial-balance, general-ledger, profit-and-loss, balance-sheet, account-ledger with text/csv/json and KPA/PMA. | Regulated TASE/tuloslaskelma PDF; --format markdown (PLAN.md). | None known. |
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file and stdin, list-templates, flags, overwrite, chdir, repo-relative template, PDF/A verified by e2e and unit tests; user can complete PDF render step. | None in PLAN.md; PDF/A (--pdfa) already verified. | None known. |
...
| [invoices](../modules/bus-invoices#development-state) | 80% (Broadly usable) – init, add, validate (totals and VAT), list with all filters, postings verified; user can complete create-and-list and postings; pdf step blocked by [pdf](../modules/bus-pdf). | attachment_id (FR-005) and postings subcommand help (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file and stdin, list-templates, flags, overwrite, chdir, repo-relative template, PDF/A verified by e2e and unit tests; user can complete PDF generation step. | None in PLAN.md; PDF/A (--pdfa) already verified. | None known. |
...
| [reports](../modules/bus-reports#development-state) | 80% (Broadly usable) – Reports, traceability (basis in JSON), and KPA/PMA verified by e2e; TASE/tuloslaskelma PDF not yet. | Regulated TASE/tuloslaskelma PDF ([design](../implementation/regulated-report-pdfs)). | None known. |
...
| [reports](../modules/bus-reports#development-state) | 80% (Broadly usable) – Trial balance and ledgers as audit evidence and KPA/PMA verified by e2e. | Regulated TASE/tuloslaskelma PDF (PLAN.md). | None known. |
...
| [invoices](../modules/bus-invoices#development-state) | 80% (Broadly usable) – init, add, validate (totals and VAT), list with all filters, postings verified; evidence-pack baseline for invoice data; pdf not in journey. | attachment_id (FR-005) and postings subcommand help (PLAN.md). | [pdf](../modules/bus-pdf) for `bus invoices pdf`. |
