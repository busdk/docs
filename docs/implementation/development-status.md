...
|--------|-----------|--------------|-----------------|
| [books](../modules/bus-books#development-state) | 20% (Basic structure) – serve and capability URL verified by e2e; token gating, workspace checks, embedded API, minimal UI, read-only 403 by unit tests; no domain backends wired; user cannot complete any bookkeeping step in the UI. | Wire [api](../modules/bus-api) backends; Dashboard and core screens (PLAN.md). | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Close-step reports verified by e2e; user can run trial-balance, general-ledger, profit-and-loss, balance-sheet, account-ledger with text/csv/json/markdown, KPA/PMA, and TASE/tuloslaskelma PDF. | None in PLAN.md. | None known. |
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file/stdin, list-templates, flags, overwrite, chdir, repo-relative template, PDF/A verified by e2e and unit tests; user can complete PDF render step. | None in PLAN.md. | None known. |
...
| [pdf](../modules/bus-pdf#development-state) | 70% (Broadly usable) – render from file/stdin, list-templates, flags, overwrite, chdir, repo-relative template, PDF/A verified by e2e and unit tests; user can complete PDF generation step. | None in PLAN.md. | None known. |
...
| [data](../modules/bus-data#development-state) | 60% (Stable) – schema, package, table, row, formula and resource add verified by e2e/unit tests; backend for [api](../modules/bus-api) and [sheets](../modules/bus-sheets). Remove/rename and schema key/fk/field commands not verified. | Resource remove/rename; schema key and foreign-key commands; field remove/rename (PLAN.md). | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Reports, traceability (basis in JSON), KPA/PMA, and TASE/tuloslaskelma PDF verified by e2e. | None in PLAN.md. | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Trial balance and ledgers as audit evidence; KPA/PMA and TASE/tuloslaskelma PDF verified by e2e. | None in PLAN.md. | None known. |
