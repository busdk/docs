...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Trial-balance, general-ledger, profit-and-loss, balance-sheet, account-ledger with text/csv/json/markdown, statutory layout ids (`fi-kpa-*`, `fi-pma-*`) with deterministic mapping contract (see [bus-reports SDD](../sdd/bus-reports)), TASE/tuloslaskelma PDF and layout selection verified by e2e; user can complete report step. | None in PLAN.md. | None known. |
...
| [data](../modules/bus-data#development-state) | 80% — Package/resource lifecycle, schema evolution, table and workbook-style read (cell/range, --header, --anchor-col/--anchor-row, --decimal-sep, --formula), row mutate; workbook doc in SDD/CLI reference pending. | Document table workbook in SDD and CLI reference (KD-DAT-005). | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Reports, traceability (basis in JSON), statutory layout ids (`fi-kpa-*`, `fi-pma-*`) and mapping contract (see [bus-reports SDD](../sdd/bus-reports)), TASE/tuloslaskelma PDF verified by e2e; user can complete compliance report step. | None in PLAN.md. | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Trial balance and ledgers as audit evidence; statutory layout ids (`fi-kpa-*`, `fi-pma-*`) and mapping contract (see [bus-reports SDD](../sdd/bus-reports)) plus TASE/tuloslaskelma PDF verified by e2e; user can produce evidence-pack reports. | None in PLAN.md. | None known. |
