...
| [bank](../modules/bus-bank#development-state) | 60% — init and import verified by e2e; list with filters and TSV verified; user can complete bank step before reconcile. | First-class profile-driven ERP bank import; schema validation before append; counterparty_id; dry-run for init. | None known. |
...
| [assets](../modules/bus-assets#development-state) | 90% — Full lifecycle and postings verified; FR-AST-003, FR-AST-004 and dispose required-args by unit and e2e. | None in PLAN.md. | None known. |
