...
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – init, add, balance, period integrity and layout/audit columns verified; add with all params via flags verified. | Optional: add convenience (all input via flags/stdin per NFR-009). | [period](../modules/bus-period) writing closed-period file for full workflow. |
...
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – postings, balancing, period reject and audit columns verified. | Optional: add convenience (all input via flags/stdin per NFR-009). | [period](../modules/bus-period) writing closed-period file for full workflow. |
...
| [journal](../modules/bus-journal#development-state) | 70% (Broadly usable) – append posting path verified; init, add, balance, closed-period reject verified. | Optional: add convenience (all input via flags/stdin per NFR-009). | [period](../modules/bus-period) writing closed-period file for full workflow. |
