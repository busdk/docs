...
|--------|-----------|--------------|-----------------|
| [books](../modules/bus-books#development-state) | 20% (Basic structure) — serve and capability URL verified by e2e; token gating, workspace checks, embedded API, minimal UI, read-only 403 by unit tests; no domain backends wired; user cannot complete any bookkeeping step in the UI. | Wire default bookkeeping module backends; Dashboard and core screens (PLAN.md). | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Close-step reports verified by e2e; trial-balance, general-ledger, profit-and-loss, balance-sheet, account-ledger with text/csv/json/markdown, KPA/PMA, TASE/tuloslaskelma PDF. | FR-REP-004 configurable report layout (built-in or layout file). | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Reports, traceability (basis in JSON), KPA/PMA, TASE/tuloslaskelma PDF verified by e2e. | FR-REP-004 configurable report layout. | None known. |
...
| [reports](../modules/bus-reports#development-state) | 90% (Broadly usable) – Trial balance and ledgers as audit evidence; KPA/PMA and TASE/tuloslaskelma PDF verified by e2e. | FR-REP-004 configurable report layout. | None known. |
