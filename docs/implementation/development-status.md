...
| [balances](../modules/bus-balances#development-state) | 60% (Stable) – Opening/cutover: init, add, import (incl. --allow-unknown-accounts), validate, list, apply and replace verified by e2e; effective-record, replace-marker, apply balanced/order by unit tests; apply uses internal journal. | [period](../modules/bus-period) library for path/state; e2e run bus journal validate after apply (PLAN.md). | None known. |
