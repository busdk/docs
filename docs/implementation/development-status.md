...
| [balances](../modules/bus-balances#development-state) | 60% (Stable) – Opening/cutover: init, add, import, validate, list, apply and replace verified by e2e; effective-record and replace-marker by unit tests; apply uses internal journal. | bus-journal (and bus-accounts, bus-period) library migration; import/apply unit tests and e2e --allow-unknown-accounts. | None known. |
