...
| [validate](../modules/bus-validate#development-state) | 50% — run and schema/invariant checks are verified; first-class source-import parity and journal-gap checks are not implemented. | format text/tsv; empty stdout and --output no-op; add parity and journal-gap checks with thresholds and CI exit behavior; audit and closed-period checks. | None known. |
...
| [validate](../modules/bus-validate#development-state) | 50% — workspace validation for coherence before close and filing is verified; first-class parity and journal-gap checks are not implemented. | format text/tsv; empty stdout; parity and journal-gap checks with thresholds and CI exit behavior; audit and closed-period checks. | None known. |
...
| [validate](../modules/bus-validate#development-state) | 50% — workspace validation before evidence pack is verified; first-class parity and journal-gap checks are not implemented. | format text/tsv; empty stdout; parity and journal-gap checks with thresholds and CI exit behavior; audit and closed-period. | None known. |
