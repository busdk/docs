...
**Prev:** [Git commit conventions per operation (external Git)](./automated-git-commits) · **Index:** [BusDK Design Document](../../index) · **Next:** [Error handling, dry-run, and diagnostics](./error-handling-dry-run-diagnostics)
<!-- busdk-docs-nav end -->
