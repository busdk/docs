...
**Prev:** [AI and external service integration](./ai-and-external-services) · **Index:** [BusDK Design Spec: Extensibility model](../extensibility/) · **Next:** [Event hooks and automation](./event-hooks-and-automation)
<!-- busdk-docs-nav end -->
