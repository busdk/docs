...
**Prev:** [Architectural overview](./architectural-overview) · **Index:** [BusDK Design Spec: System architecture](../02-architecture) · **Next:** [Git-backed data repository (the data store)](./git-backed-data-store)
<!-- busdk-docs-nav end -->
