...
**Prev:** [BusDK Design Spec: Design goals and requirements](../01-design-goals) · **Index:** [BusDK Design Document](../../index) · **Next:** [Auditability through append-only changes](./append-only-auditability)
<!-- busdk-docs-nav end -->
