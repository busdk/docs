...
**Prev:** [CSV conventions](./csv-conventions) · **Index:** [BusDK Design Spec: Data format and storage](../03-data-formats-and-storage) · **Next:** [Scaling over decades](./scaling-over-decades)
<!-- busdk-docs-nav end -->
