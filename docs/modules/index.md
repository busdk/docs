...
Local interfaces are [`bus api`](./bus-api), [`bus api provider books`](./bus-api-provider-books), [`bus api provider data`](./bus-api-provider-data), [`bus api provider session`](./bus-api-provider-session), [`bus sheets`](./bus-sheets), [`bus books`](./bus-books), [`bus chat`](./bus-chat), [`bus ui`](./bus-ui), and [`bus portal`](./bus-portal). They expose workspace data, assistant chat, provider adapters, and browser-facing UIs.
