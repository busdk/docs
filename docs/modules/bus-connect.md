...
description: "bus-connect is a self-hostable BusDK daemon that gates new conversation threads with x402 payments; the daemon has passed review and real-backend proof but is not yet released."
---
