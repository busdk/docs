...
**Planned next:** PLAN.md lists no open items; optional interactive add for usability (would advance [Accounting workflow](../workflow/accounting-workflow-overview)).
