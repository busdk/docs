...
`bus bank statement parse --file <path> [--profile <name>|--profile-name <name>] [--account <id>] [--iban <iban>] [--attachment-id <uuid>] [--header-row <n>] [--map <field=header-or-column>] [--date-format <format>] [--decimal-sep <char>] [--group-sep <char|space|nbsp|none>] [--unicode-minus] [-C <dir>] [-o <file>] [-f json] [global flags]`  
