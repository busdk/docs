...
bus dev each --check --jobs 4 stage commit
...
bus dev each --check --skip bus-docs --jobs 4 stage commit
bus dev each --jobs 4 --skip bus-docs,bus-legacy stage commit
