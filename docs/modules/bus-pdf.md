...
**Completeness:** 70% — render from file and stdin, list-templates, global flags, overwrite, chdir, and repo-relative template path verified by e2e and unit tests; user can complete the PDF render step.
