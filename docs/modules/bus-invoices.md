...
**Completeness:** 80% — init, add (header/lines), validate (totals and VAT), list with all filters, and postings verified by e2e and unit tests; record-invoices and postings journey completable; pdf not verified in e2e.
