...
- [BusDK Software Design Document (SDD)](sdd/docs/sdd.md) — single-page consolidated view of goals, requirements, architecture, and key decisions.
- [Module SDDs](sdd/docs/modules/modules.md) — per-module SDDs (e.g. [bus-init](sdd/docs/modules/bus-init.md), [bus-data](sdd/docs/modules/bus-data.md), [bus-dev](sdd/docs/modules/bus-dev.md), [bus-validate](sdd/docs/modules/bus-validate.md)).
